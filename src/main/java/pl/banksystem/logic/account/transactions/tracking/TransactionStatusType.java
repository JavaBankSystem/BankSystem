package pl.banksystem.logic.account.transactions.tracking;
...
import pl.banksystem.logic.account.transactions.TransactionType;
import pl.banksystem.logic.account.transactions.tracking.processes.CanceledProcess;
import pl.banksystem.logic.account.transactions.tracking.processes.DoneProcess;
import pl.banksystem.logic.account.transactions.tracking.processes.StatusProcess;
    ...
    public Transaction proccessTransaction(Transaction transaction) {
        ...
        if (this.getAcceptedStatus()
            ...
            logger.error("Change status problem!! Last status: {}, new TransactionStatusType: {}",
                    transaction.getActuallTransactionStatus().getTransactionStatusType(), this);
            return null;
        }
    }
}
